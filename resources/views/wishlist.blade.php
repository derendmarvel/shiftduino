        ...
        <div class = "row justify-content-center align-items-center align-middle p-5">
            @if($wishlists->isNotEmpty())
                ...
                @foreach ($wishlists as $product)
                    <div class = "col-4 shadow-sm rounded-3 p-0 m-3" data-aos="fade-up" data-aos-duration="1500" data-aos-delay="500">
            ...
            @else
                ...
                <h1 class = "fw-bold fs-1 mb-2 pb-0 text-center" data-aos="fade-up" data-aos-duration="1500"> Wishlist is Empty. </h1>
                    <a class = " w-50 btn btn-outline-dark rounded-0 px-5 py-2 my-2" href = "/products" data-aos="fade-up" data-aos-duration="1500" data-aos-delay = "250"> Browse Catalog </a>
                </div>
            @endif
        </div>
@endsection